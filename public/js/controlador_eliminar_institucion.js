...
let mostrar_datos = () => {
    ...
    select_institucion_tipo.value = institucion[0]['institucion_tipo'];
    select_institucion_generos.value = institucion[0]['institucion_generos'];
    ...
    imagen_institucion.value = institucion[0]['institucion_imagen'];
...
let obtener_datos = () => {
    ...
    let institucion_bachillerato_internacional = 'No';
    ...
    Swal.fire({
        title: '¿Está seguro que desea eliminar el centro educativo?',
        type: 'warning',
        ...
        if (result.value) {
            eliminar_institucion(_id, institucion_nombre, institucion_nombre_encargado, institucion_apellido_encargado, institucion_departamento_encargado, institucion_telefono, institucion_correo_electronico, institucion_nombre_inscrito, institucion_ideologia, institucion_bachillerato_internacional, institucion_fundacion, institucion_referencia, institucion_tipo, institucion_generos, institucion_cedula, institucion_provincia, institucion_canton, institucion_distrito, institucion_direccion, institucion_sitio_web, institucion_fax, institucion_imagen, institucion_facebook, institucion_twitter, institucion_cedula_encargado, institucion_correo_electronico_encargado);
        }
    }
    )
